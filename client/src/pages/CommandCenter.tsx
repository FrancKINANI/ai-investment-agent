...
import { Activity, ArrowRight, CircleAlert, CircleHelp, Gauge, Landmark, MessageSquareText, Plus, Radar, RefreshCw, Send, ShieldAlert, ShieldCheck, Sparkles, Target, WalletCards, X } from "lucide-react";
...
export default function CommandCenter() {
  ...
  const runEvidenceResearch = async (event: FormEvent) => {
    ...
    try {
      ...
      toast.success("Evidence research completed", { description: "A paper proposal state is now visible in the queue." });
