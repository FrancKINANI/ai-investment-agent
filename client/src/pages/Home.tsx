...
export default function Home() {
  ...
  const savePolicy = async (event: FormEvent) => {
    ...
    try {
      ...
      toast.success("IPS saved", { description: "The policy is versioned. Execution remains simulation-only." });
    } catch (error) {
  ...
  const startResearch = async (event: FormEvent) => {
    ...
    try {
      ...
      toast.success("Research report ready", { description: "The response is source-bound and simulation-only." });
    } catch (error) {
