...
export default function Chat() {
  ...
  return <div className="solo-chat-page">
    <header className="solo-chat-heading"><div><span className="eyebrow">SUPERVISOR CONVERSATION</span><h1>Debate the thesis.<br /><em>Keep the authority bounded.</em></h1><p>Persistent owner-scoped research conversation. Bull and Bear notes remain visibly distinct, while the Fund Manager records the disagreement without approving an execution.</p></div><div className="solo-chat-status"><span><i className={chatMutation.isPending ? "pulse" : ""} /> {chatMutation.isPending ? "delegating research" : "research fabric ready"}</span><small>paper-only</small></div></header>
