...
export type BinanceErrorCode =
  ...
  | "BINANCE_TIMEOUT"
  | "BINANCE_UPSTREAM_REJECTED"
  | "BINANCE_UPSTREAM_UNAVAILABLE";

/**
 * Stable error envelope for Binance responses. Upstream bodies and signed URLs
 * are intentionally excluded because they may contain sensitive material.
 */
